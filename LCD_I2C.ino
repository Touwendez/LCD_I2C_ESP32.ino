/**********************************************************************
  qui démontre comment piloter un afficheur LCD1602 en utilisant la bibliothèque
   LiquidCrystal_I2C. Le code utilise le protocole I2C pour contrôler l'affichage.
   Réaliser avec un Frenove ESP32 Wrover
   Câblage : GND-->GND
            VCC--> 5V
            SDA-->13
            SCL-->14
